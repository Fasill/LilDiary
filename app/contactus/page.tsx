      ...
      <div className="max-w-md w-full space-y-8">
        <div className="text-center">
          ...
          <p className="mt-4 text-lg text-secondary">
            Getting in Touch with LillDiary
          </p>
          <p className="mt-2 text-gray-700">
            We love hearing from LillDiary families! Please see the options
        ...
        <div className="mt-8 space-y-6">
          <div className="flex items-center justify-center bg-white shadow-lg rounded-lg p-4">
            ...
            <span className="ml-4 text-gray-800 text-lg">
              Call: +1987654321
            </span>
          </div>
        ...
        <div className="text-center mt-10">
          <p className="text-sm text-gray-600">
            We sincerely appreciate you choosing{" "}
            <span className="font-bold">LillDiary</span> as your family memory
            keeper and can’t wait to hear from you!
          </p>
        </div>
      </div>
    </div>
