    ...
    <div className="max-w-[1100px] gap-[2rem] grid grid-cols-12 grid-rows-2 px-8 bg-white2">
      ...
      <Card className="col-span-12 sm:col-span-4 h-[300px] group">
        ...
        <CardFooter className="absolute bg-black/80 bottom-0 border-t-1 border-zinc-100/50 z-10 justify-between transform transition-transform duration-300 translate-y-[100%] group-hover:translate-y-[2px]">
          <p className="text-[#fcfcfc] text-[0.9rem]">
            Never wonder if you tracked your little one&lsquo;s first step, first tooth, or other milestones. LillDiary lets you log these key moments and will automatically compile milestone memories in your child&lsquo;s timeline.
          </p>
        </CardFooter>
      </Card>
      ...
      <Card className="col-span-12 sm:col-span-4 h-[300px] group">
        ...
        <CardFooter className="absolute bg-black/80 bottom-0 border-t-1 border-zinc-100/50 z-10 justify-between transform transition-transform duration-300 translate-y-[100%] group-hover:translate-y-[2px]">
          <p className="text-[#fcfcfc] text-[0.9rem]">
            Run out of room on your phone capturing photos and videos? No problem. LillDiary offers unlimited full resolution photo and video uploads and storage, safely secured with 256-bit encryption.
          </p>
        </CardFooter>
      </Card>
      ...
      <Card isFooterBlurred className="w-full h-[300px] col-span-12 sm:col-span-5 group">
        ...
        <CardFooter className="absolute bg-black/80 bottom-0 border-t-1 border-zinc-100/50 z-10 justify-between transform transition-transform duration-300 translate-y-[100%] group-hover:translate-y-[2px]">
          <p className="text-[#fcfcfc] text-[0.9rem]">
            Invite grandparents, relatives, or friends to add their own photos and stories to your child&lsquo;s diary. LillDiary makes sharing simple with customizable access controls, ensuring entries remain private until you decide to share more publicly.
          </p>
        </CardFooter>
      </Card>
      ...
      <Card isFooterBlurred className="w-full h-[300px] col-span-12 sm:col-span-7 group">
        ...
        <CardFooter className="absolute bg-black/80 bottom-0 border-t-1 border-zinc-100/50 z-10 justify-between transform transition-transform duration-300 translate-y-[100%] group-hover:translate-y-[2px]">
          <p className="text-[#fcfcfc] text-[0.9rem]">
            At LillDiary, we strive to build lifelong connections between parents and children through saved memories. Much more than just a baby book, your child&lsquo;s LillDiary grows alongside them, chronicling precious moments from every stage.
            We invite you to join millions of other families already using LillDiary to effortlessly capture photos, videos, milestones, and memories without fear of lost photos, privacy concerns, or storage limits. Sign up today for your free account and start building your family&lsquo;s LillDiary! Capture your children&lsquo;s childhoods to cherish for a lifetime and pass on to future generations.
          </p>
        </CardFooter>
      </Card>
    </div>
