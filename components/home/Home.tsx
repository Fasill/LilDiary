    ...
    <div className="flex items-center justify-between h-full p-[5rem]">
      <div className='z-[999] flex flex-col items-evenly justify-evenly h-full'>
        <div className='flex  flex-col items-start gap-[1rem]'>
          <h1 className='text-[4rem] text-white2 font-bold max-md:text-[2rem]'>
            Capture Your Family&apos;s Precious Memories with LillDiary
          </h1>
          <p className='text-white2 text-[1.5rem] w-[80%] '>
      ...
      <div className='w-[80%] z-[999]  h-[100%] flex flex-col justify-between items-end max-md:hidden'>
        <div>{""}</div>
