  ...
  return (
    <div>
      ...
      >
        ...
        <NavbarContent className="hidden sm:flex gap-4" justify="end">
          <NavbarItem
            className={`text-lg cursor-pointer ${
              activeNavItem === "blog" ? "font-bold text-primary" : ""
            }`}
          ...
          <NavbarItem
            className={`text-lg cursor-pointer ${
              activeNavItem === "ourStory" ? "font-bold text-primary" : ""
            }`}
        ...
        <div
          className={`fixed top-0 right-0 h-[100lvh] w-[250px] bg-[#3a1c1cc7] shadow-lg z-[10000] transform sm:hidden text-[white] ${
          ...
          <div className="flex flex-col gap-6 p-6">
            <NavbarItem
              className={`text-md cursor-pointer ${
                activeNavItem === "home" ? "font-bold text-primary" : ""
              }`}
            ...
            <NavbarItem
              className={`text-md cursor-pointer ${
                activeNavItem === "aboutUs" ? "font-bold text-primary" : ""
              }`}
            ...
            <Dropdown>
              <DropdownTrigger>
                <p
                  className={`self-start flex items-center justify-center text-md cursor-pointer ${
                    activeNavItem === "privacyPolicy" ||
                    activeNavItem === "termsAndConditions"
              ...
              <DropdownMenu aria-label="Policy Menu">
                <DropdownItem
                  key="privacy"
                  onClick={() =>
                    handleNavItemClick("privacyPolicy", "/privacyPolicy")
                  }
                >
                  Privacy Policy
                </DropdownItem>
            ...
            <NavbarItem
              className={`text-md cursor-pointer  ${
                activeNavItem === "contactUs" ? "text-[#ff49bf] font-bold" : ""
              }`}
